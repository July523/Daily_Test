...
class Bullet(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # 子弹四个方向(上下左右)
        self.bullets = ['E:/pycharm/coding/Daily_Test/Game_test/game2_tank/images/bullet/bullet_up.png',
                        'E:/pycharm/coding/Daily_Test/Game_test/game2_tank/images/bullet/bullet_down.png',
                        'E:/pycharm/coding/Daily_Test/Game_test/game2_tank/images/bullet/bullet_left.png',
                        'E:/pycharm/coding/Daily_Test/Game_test/game2_tank/images/bullet/bullet_right.png']
        # 子弹方向(默认向上）
