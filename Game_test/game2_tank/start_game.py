# coding=utf-8 
# @Time :2018/12/20 14:44

from Daily_Test.Game_test.game2_tank import scene, food, tanks, home
import sys
import pygame
...
def show_start_interface(screen, width, height):
    tfont = pygame.font.Font('E:/pycharm/coding/Daily_Test/Game_test/game2_tank/font/simkai.ttf', width // 4)
    cfont = pygame.font.Font('E:/pycharm/coding/Daily_Test/Game_test/game2_tank/font/simkai.ttf', width // 20)
...
def show_end_interface(screen, width, height, is_win):
    bg_img = pygame.image.load("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/images/others/background.png")
    screen.blit(bg_img, (0, 0))
    if is_win:
        font = pygame.font.Font('E:/pycharm/coding/Daily_Test/Game_test/game2_tank/font/simkai.ttf', width // 10)
        content = font.render(u'恭喜通关！', True, (255, 0, 0))
        rect = content.get_rect()
        rect.midtop = (width / 2, height / 2)
        screen.blit(content, rect)
    else:
        fail_img = pygame.image.load("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/images/others/gameover.png")
...
def main():
    ...
    pygame.display.set_caption("Peter的小游戏")
    # 加载图片
    bg_img = pygame.image.load("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/images/others/background.png")
    # 加载音效
    add_sound = pygame.mixer.Sound("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/audios/add.wav")
    add_sound.set_volume(1)
    bang_sound = pygame.mixer.Sound("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/audios/bang.wav")
    bang_sound.set_volume(1)
    blast_sound = pygame.mixer.Sound("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/audios/blast.wav")
    blast_sound.set_volume(1)
    fire_sound = pygame.mixer.Sound("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/audios/fire.wav")
    fire_sound.set_volume(1)
    Gunfire_sound = pygame.mixer.Sound("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/audios/Gunfire.wav")
    Gunfire_sound.set_volume(1)
    hit_sound = pygame.mixer.Sound("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/audios/hit.wav")
    hit_sound.set_volume(1)
    start_sound = pygame.mixer.Sound("E:/pycharm/coding/Daily_Test/Game_test/game2_tank/audios/start.wav")
    ...
    while not is_gameover:
        ...
        myhome = home.Home()
        # 出场特效
        appearance_img = pygame.image.load("E:/pycharm/coding/Daily_Test"
                                           "/Game_test/game2_tank/images/others/appear.png").convert_alpha()
