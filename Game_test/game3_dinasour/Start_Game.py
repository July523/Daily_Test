...
from Daily_Test.Game_test.game3_dinasour.Scene import Scene
from Daily_Test.Game_test.game3_dinasour.Obstacle import Plant, Ptera
from Daily_Test.Game_test.game3_dinasour.Dinasour import Dinosaur
...
def main():
    ...
    while running:
        ...
        for ptera in pteras:
            ...
            ptera.draw(screen)
        # 碰撞检测
        if pygame.sprite.spritecollide(dinosaur, plants, False) or \
                pygame.sprite.spritecollide(dinosaur, pteras, False):
            die_sound.play()
            running = False
        # 显示得分
