...
皮卡丘跳跃游戏,仿八分音符的声控小游戏
具体参考：
https://github.com/CharlesPikachu/Games/blob/master/Game2
"""
...
from Daily_Test.Game_test.game1_picachu.classes.pikachu import Pikachu
from Daily_Test.Game_test.game1_picachu.classes.block import Block
